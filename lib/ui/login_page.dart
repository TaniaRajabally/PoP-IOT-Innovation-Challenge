...
import 'package:pop/style/theme.dart' as Theme;
import 'package:pop/utils/bubble_indication_painter.dart';
                  ...
                  Expanded(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("Simplying Agricultural needs for Everyone",
                        ...
                        if (pass == input_pass) {
                          Navigator.of(context).push(new MaterialPageRoute(
                              builder: (BuildContext context) =>
                                  new WhatsAppHome(aadhar, email, name, state,
                                      reward, age, sex, role, crops)));
                        }
                      });
                ...
                child: MaterialButton(
                    ...
                    onPressed: () {
                      ...
                      if (signupAadharController.value.text != null &&
                        ...
                        String aadhar = signupAadharController.value.text;
